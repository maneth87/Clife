<%@ Page Title="Clife | Administrator => Underwriting" Language="C#" MasterPageFile="~/Administrator/Admin.master" AutoEventWireup="true" CodeFile="underwriting.aspx.cs" Inherits="Administrator_Underwriting_underwriting" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Toolbar" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function SelectSingleCheckBox(ckb, app_register_id, product_id, system_sum_insured, system_premium, pay_mode, gender, age, status_code, pay_up_to_age, assure_up_to_age, pay_year, assure_year, original_amount, rounded_amount, app_date, birth_date, user_premium) {
