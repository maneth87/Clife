<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="frm_gm_official_receipt_list.aspx.cs" Inherits="Pages_Finance_frm_gm_official_receipt_list" %>
                            ...
                            <div style="float: left; padding: 5px 5px 5px 5px; height: 300px; overflow-y: scroll;">
                                <asp:GridView ID="gv_valid" CssClass="grid-layout" runat="server" AutoGenerateColumns="False" Width="100%" HorizontalAlign="Center" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#21275b" OnRowCommand="gv_valid_RowCommand" OnRowDataBound="gv_valid_RowDataBound">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Official Receipt Id" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblOfficialReceiptId" Width="150px" runat="server" Text='<%#Eval("official_receipt_id") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Policy Number">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPolicyNumber" Width="150px" runat="server" Text='<%# Eval("policy_number") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Pay Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPayDate" Width="150px" runat="server" Text='<%# Convert.ToDateTime( Eval("Pay_Date")).ToString("dd-MMM-yy") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:TemplateField>
