<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="04frmRiderRateSetup.aspx.cs" Inherits="Pages_Products_04frmRiderRateSetup" %>
        ...
        <asp:UpdatePanel ID="UP" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="panel-heading">
                    <h2 class="panel-title">SETUP RIDER RATE</h2>
                </div>
                <div class="panel-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">SEARCH RIDERS RATE</h3>
                        </div>
                        <div class="panel-body">
                            <table>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">RIDER RATE LIST
                            </h3>
