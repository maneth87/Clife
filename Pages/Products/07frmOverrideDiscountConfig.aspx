<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="07frmOverrideDiscountConfig.aspx.cs" Inherits="Pages_Products_07frmOverrideDiscountConfig" %>
        ...
        <asp:UpdatePanel ID="UP" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="panel-heading">
                    <h2 class="panel-title">OVERRIDE DISCOUNT CONFIGURATION</h2>
                </div>
                <div class="panel-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">SEARCH OVERRIDE DISCOUNT</h3>
                        </div>
                        <div class="panel-body">
                            <table>
                                <tr>
                                    ...
                                    <td colspan="2">
                                        ...
                                        <asp:DropDownList ID="ddlSearchBy" runat="server"></asp:DropDownList>
                                    </td>
                                    <td>
                                        Value:
                                    </td>
                                    <td>
                                         <asp:TextBox ID="txtValue" placeholder="INPUT VALUE TO SEARCH" runat="server" ></asp:TextBox>
                                    </td>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">OVERRIDE DISCOUNT LIST
                            </h3>
                            ...
                            <asp:GridView ID="gvParam" CssClass="grid-layout" runat="server" AutoGenerateColumns="False" Width="100%" HorizontalAlign="Center" OnRowEditing="gvParam_RowEditing" PageSize="10" AllowPaging="true" OnPageIndexChanging="gvParam_PageIndexChanging" AlternatingRowStyle-BackColor="#C2D69B">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="CUSTOMER NAME" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCustomerName" Width="80px" runat="server" Text='<%#Eval("CustomerName") %>'> </asp:Label>
                                            <asp:Label ID="lblCustomerId" Width="80px" Visible="false" runat="server" Text='<%#Eval("CustomerId") %>'></asp:Label>
                                            <asp:Label ID="lblCustomerNumber" Width="80px" Visible="false" runat="server" Text='<%#Eval("CustomerNumber") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="POLICY NUMBER" Visible="true" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblPolicyNumber" Width="80px" runat="server" Text='<%#Eval("PolicyNumber") %>'> </asp:Label>
                                            <asp:Label ID="lblPolicyId" Width="80px" Visible="false" runat="server" Text='<%#Eval("PolicyId") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                        ...
                        <div class="panel-body" id="divAddContent">
                            ...
                            <table id="tblAddContent">
                                ...
                                <tr>
                                    ...
                                    <td>Basic Dis. Amount:<span style="color: red; font-weight: bold;">*</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>Rider Dis. Amount:<span style="color: red; font-weight: bold;">*</span>
                                    </td>
                                    <td>
