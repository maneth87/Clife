<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="08frmProductCommissionConfig.aspx.cs" Inherits="Pages_Products_08frmProductCommissionConfig" %>
        ...
        <asp:UpdatePanel ID="UP" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="panel-heading">
                    <h2 class="panel-title">COMMISSION CONFIGURATION</h2>
                </div>
                <div class="panel-body">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td colspan="2">
                                        ...
                                        <asp:DropDownList ID="ddlSeachBy" runat="server"></asp:DropDownList>
                                    </td>
                                     <td>Value: 
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtSearchValue" placeholder="INPUT VALUE TO SEARCH" runat="server" ></asp:TextBox>
                                    </td>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">COMMISSION CONFIG LIST
                            </h3>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="CAHNNEL NAME">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblChannelId" Width="150px" Visible="false" runat="server" Text='<%# Eval("ChannelItemId")  %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="COMMISSION TYPE" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCommissionType" Width="80px" runat="server" Text='<%#Eval("CommissionType") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="VALUE TYPE" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lblValueType" Width="60px" runat="server" Text='<%#Eval("ValueType") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="VALUE">
                                        <ItemTemplate>
                                            <asp:Label ID="lblValue" Width="20px" runat="server" Text='<%# Eval("Value").ToString()  %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="EFFECTIVE FROM">
                                        <ItemTemplate>
                                            <asp:Label ID="lblEffectiveFrom" Width="20px" runat="server" Text='<%# Convert.ToDateTime( Eval("EffectiveFrom").ToString()).ToString("dd/MM/yyyy")  %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="EFFECTIVE TO">
                                        <ItemTemplate>
                                            <asp:Label ID="lblEffectiveTo" Width="20px" runat="server" Text='<%# Convert.ToDateTime( Eval("EffectiveTo").ToString()).ToString("dd/MM/yyyy")  %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="REMARKS">
                                        <ItemTemplate>
                                            <asp:Label ID="lblRemarks" Width="150px" runat="server" Text='<%# Eval("CreatedRemarks")  %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                        ...
                        <div class="panel-body" id="divAddContent">
                            ...
                            <table id="tblAddContent">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlProduct" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlProduct_SelectedIndexChanged1"></asp:DropDownList>
                                    </td>
                                    <td>Product Name:
                                    </td>
                                    <td colspan="3" class="colspan3">
                                        <asp:TextBox ID="txtProductName" runat="server" width="97%"></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>Value:<span style="color: red; font-weight: bold;">*</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>Effective From:<span style="color: red; font-weight: bold;">*</span>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtEffectiveFrom" placeholder="DD/MM/YYYY" runat="server"></asp:TextBox>
                                    </td>
                                    <td>Effective To:<span style="color: red; font-weight: bold;">*</span>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtEffectiveTo" placeholder="DD/MM/YYYY" runat="server"></asp:TextBox>
                                    </td>
