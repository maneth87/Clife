<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="add_new_transaction_list.aspx.cs" Inherits="Pages_GTLI_add_new_transaction_list" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Toolbar" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ShowSearchForm() {
            ...
            $("#myModalSearchAddedList").modal("show");
        }
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="Server">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Added Members List</h3>
        </div>
            ...
            <div>
                <asp:GridView ID="gvGTLI" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="GTLI_Premium_ID" BorderColor="#B9B9B9" AllowPaging="True" PageSize="30" OnPageIndexChanged="gvGTLI_PageIndexChanged" OnPageIndexChanging="gvGTLI_PageIndexChanging" OnRowCommand="gvGTLI_RowCommand" OnRowDataBound="gvGTLI_RowDataBound">
                    <Columns>
                        ...
                        <asp:BoundField DataField="Effective_Date" HeaderText="Effective Date" SortExpression="Effective_Date" DataFormatString="{0:dd-MMM-yyyy}" HtmlEncode="false" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" ItemStyle-Width="80">
                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
...
<ItemStyle Width="250px"></ItemStyle>
            ...
            <div style="text-align: right; width: 100%">
                <asp:Button ID="btnTotalAddNew" runat="server" Text="View Total Added Member" Height="35px" Visible="False" OnClick="btnTotalAddNew_Click" />
            </div>
        </div>
    </div>
       <%--Modal Search Added List Form --%>
    <div id="myModalSearchAddedList" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalSearchAddedListHeader" aria-hidden="true">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h3 class="panel-title">GTLI Added List Search</h3>
        </div>
    ...
    <%--End Modal GTLI Added List Search--%>
</asp:Content>
