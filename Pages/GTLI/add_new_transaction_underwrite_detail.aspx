<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="add_new_transaction_underwrite_detail.aspx.cs" Inherits="Pages_GTLI_add_new_transaction_underwrite_detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="Server">
    ...
    <div id="tabs">
        <ul class="hideelement">
            <li><a href="#tabs-1">Add Member Underwriting Transaction Summary</a></li>
            <li><a href="#tabs-2">Premium Underwriting Details</a></li>
        </ul>      
            <div id="tabs-1">
                ...
                <table  cellpadding="0" cellspacing="0" width="97%" align="center" border="1">
                    <tr>
                        <td class="td-left" style="border-right: none; width:200px">
                            Policy No.<br />
                            Payment Code<br />
                    ...
                    <tr>
                        <td class="td-left" style="border-right: none;">
                            The Insured's Name<br />
                            Type of Business<br />
                            Contact Person<br />
                            Phone Contact<br />
                            Email<br />
            ...
            <div id="tabs-2" align="center">
                <br />
                 <h3 style="color: Black; font-weight: bold; font-family:Arial">
                            Employee Premium Underwriting Details</h3>
                <br />               
                <table id="tblPremiumDetail" class="gridtable" cellspacing="0" width="98%" runat="server" >
