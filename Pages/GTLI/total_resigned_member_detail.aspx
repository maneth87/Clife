<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="total_resigned_member_detail.aspx.cs" Inherits="Pages_GTLI_total_resigned_member_detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="Server">
    ...
    <div id="tabs">
        <ul class="hideelement">
            <li><a href="#tabs-1">Total Policy Resigned Member Summary</a></li>
            <li><a href="#tabs-2">Total Premium Returned Details</a></li>
        </ul>
        <div id="tabs-1">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" align="center" border="1">
                <tr>
                    <td class="td-left" style="border-right: none;">Policy No.                              
        ...
        <div id="tabs-2" align="center">
            <br />
            <h3 style="color: Black; font-weight: bold; font-family: Arial">Total Employee Premium Return Details</h3>
            <br />
    ...
    <div id="printContent">
        ...
        <table class="table" cellpadding="0" cellspacing="0" width="96%" align="center">
            <tr>
                <td class="td-left">Policy No.                              
                                                              
                </td>
                <td class="td-center">:                               
                </td>
                <td class="td-right">
                    <asp:Label ID="lblPolicyNumber2" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
