<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="edit_company.aspx.cs" Inherits="Pages_GTLI_edit_company" %>
   ...
   <style>
    ...
    <script type="text/javascript">
        ...
        function ShowSearchForm() {
            ...
            $("#myModalSearchCompany").modal("show");
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" Runat="Server">
    ...
    <div id="myModalSearchCompany" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalSearchCompanyHeader" aria-hidden="true">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h3 class="panel-title">GTLI Company Search</h3>
        </div>
        <div class="modal-body">
            <%--Modal Body--%>
           <table width="100%">
                <tr>
                    ...
                    <td width="88%">
                        <asp:TextBox ID="txtCompanyName" runat="server" Width="97%" Font-Size="10pt" TabIndex="1" ClientIDMode="Static" MaxLength="255"></asp:TextBox>
