<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="total_added_member_detail.aspx.cs" Inherits="Pages_GTLI_total_added_member_detail" %>
    ...
    <br />
        ...
        <div id="tabs">
            <ul class="hideelement">
                <li><a href="#tabs-1">Total Policy Added Member Summary</a></li>
                <li><a href="#tabs-2">Total Premium Details</a></li>
            </ul>
            <div id="tabs-1">
            ...
            <div id="tabs-2" align="center">
                <br />
                <h3 style="color: Black; font-weight: bold; font-family: Arial">Total Employee Premium Details</h3>
                <br />
