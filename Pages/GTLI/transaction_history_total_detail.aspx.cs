...
public partial class Pages_GTLI_transaction_history_total_detail : System.Web.UI.Page
{
   
    protected void Page_Load(object sender, EventArgs e)
    {
        //get list of policy from query string
        string query_string = Request.QueryString.Get("pid");
        ...
        //get list of plans
        ArrayList list_of_plan_id = new ArrayList();

        //loop through list_of_policy
        for (int i = 0; i <= list_of_premium_id.Count - 1; i++)
        {
            ...
            else
            {
                ...
                //loop through list_of_plan_id
                if (list_of_plan_id.Count > 0)
                {
                    bool result = false;
                    for (int j = 0; j <= list_of_plan_id.Count - 1; j++)
                    {
                        if (my_premium.GTLI_Plan_ID == list_of_plan_id[j].ToString())
                        {
                            result = true;
                        }
                    }
                    if (result == false)
                    {
                        list_of_plan_id.Add(my_premium.GTLI_Plan_ID);
                    }

                    list_of_plan_id.Sort();
                }
                else
                {
                    list_of_plan_id.Add(my_premium.GTLI_Plan_ID);
        ...
        string plan = "";
        for (int i = 0; i <= list_of_plan_id.Count - 1; i++)
        {
            bl_gtli_plan myplan = new bl_gtli_plan();
            myplan = da_gtli_plan.GetPlan(list_of_plan_id[i].ToString());
            ...
            {
                dhc = myplan.DHC_Option_Value.ToString("C0");
            }
            else
            {
                dhc = "No";
            }
            plan += myplan.GTLI_Plan + ":" + myplan.Sum_Insured.ToString("C0") + ", TPD: " + tpd + ", DHC: " + dhc + "<br />";
        }

        dvPlan.InnerHtml = plan;
        ...
        //get list of sale from query string                                                                                
        ...
        //view original sale premium detail
        ...
        for (int i = 0; i <= list_of_premium_id.Count - 1; i++)
        {
            ...
            if (my_premium.Transaction_Type == 3)
            {
                ...
                all_rows += this_policy_employee.Count;
                ...
                for (int k = 0; k <= this_policy_employee.Count - 1; k++)
                {
                    ...
                    string plan_name = da_gtli_plan.GetPlan(original_premium.GTLI_Plan_ID).GTLI_Plan;
                    ...
                    tr_red.Controls.Add(tc_100plus_premium);
                    ...
                    if (employee.Certificate_Number != 999999)
                    {
                        ...
                        strTableDetailPrint += "<td style='text-align: right; padding-right: 6px; color: red'>(" + original_premium.Sum_Insured.ToString("C0") + ")</td>";
                    }else{
                        strTableDetailPrint += "<td style='text-align: center; color: red' width='30px'>" + (number).ToString() + "</td>";
                    ...
                    if (my_100plus_premium != 0)
                    {
                        strTableDetailPrint += "<td style='text-align: right; padding-right: 6px; color: red'>(" + my_100plus_premium.ToString("C2") + ")</td>";
                    }
                    else
                    {
                        strTableDetailPrint += "<td style='text-align: right; padding-right: 6px; color: red'> - </td>";
                    ...
                    if (life_premium + tpd_premium + dhc_premium + my_100plus_premium > 0)
                    {
                        strTableDetailPrint += "<td style='text-align: right; padding-right: 6px; color: red'>(" + (life_premium + tpd_premium + dhc_premium + my_100plus_premium).ToString("C2") + ")</td>";
            ...
            else
            {
                ...
                all_rows += this_policy_employee2.Count;
                ...
                for (int k = 0; k <= this_policy_employee2.Count - 1; k++)
                {
                    ...
                    if (my_premium.Transaction_Type == 2)
                    {
                        //Color green
                        //Row
                        ...
                        if (myemployee.Certificate_Number != 999999)
                        {
                            ...
                            strTableDetailPrint += "<td style='text-align: left; padding-left: 5px; color: green'>" + myemployee.Employee_Name + "</td>";
                        ...
                        {
                            strTableDetailPrint += "<td style='text-align: center; color: green' width='30px'>" + (number).ToString() + "</td>";
                            strTableDetailPrint += "<td style='padding-left: 5px; color: green'> - </td>";
                            strTableDetailPrint += "<td style='text-align: left; padding-left: 5px; color: green'>" + myemployee.Employee_Name + "</td>";
                            strTableDetailPrint += "<td style='text-align: center; color: green'> - </td>";
                            strTableDetailPrint += "<td style='text-align: center; color: green'> - </td>";
                            strTableDetailPrint += "<td style='text-align: center; color: green'> - </td>";
                            strTableDetailPrint += "<td style='text-align: center; color: green'> - </td>";
                        ...
                        if (my_100plus_premium != 0)
                        {
                            strTableDetailPrint += "<td style='text-align: right; padding-right: 6px; color: green'>" + my_100plus_premium.ToString("C2") + "</td>";
                        }
                        else
                        {
                            strTableDetailPrint += "<td style='text-align: right; padding-right: 6px; color: green'> - </td>";
                        ...
                        if (life_premium + tpd_premium + dhc_premium + my_100plus_premium > 0)
                        {
                            strTableDetailPrint += "<td style='text-align: right; padding-right: 6px; color: green'>" + (life_premium + tpd_premium + dhc_premium + my_100plus_premium).ToString("C2") + "</td>";
                    ...
                    else
                    {
                        ...
                        if (myemployee.Certificate_Number != 999999)
                        {
                            ...
                            strTableDetailPrint += "<td style='text-align: left; padding-left: 5px; color: black'>" + myemployee.Employee_Name + "</td>";
                            strTableDetailPrint += "<td style='text-align: center; color: black'>" + plan_name + "</td>";
                            strTableDetailPrint += "<td style='text-align: center; color: black'>" + my_premium.Effective_Date.ToString("d-MMM-yyyy") + "</td>";
                            strTableDetailPrint += "<td style='text-align: center; color: black'>" + my_premium.Expiry_Date.ToString("d-MMM-yyyy") + "</td>";
                            strTableDetailPrint += "<td style='text-align: center; color: black'>365</td>";
                            strTableDetailPrint += "<td style='text-align: right; padding-right: 6px; color: black'>" + my_premium.Sum_Insured.ToString("C0") + "</td>";
                        }
                        else
                        {
                            strTableDetailPrint += "<td style='text-align: center; color: black' width='30px'>" + (number).ToString() + "</td>";
                        ...
                        if (my_100plus_premium != 0)
                        {
                            strTableDetailPrint += "<td style='text-align: right; padding-right: 6px; color: black'>" + my_100plus_premium.ToString("C2") + "</td>";
                        }
                        else
                        {
                            strTableDetailPrint += "<td style='text-align: right; padding-right: 6px; color: black'> - </td>";
                        ...
                        if (life_premium + tpd_premium + dhc_premium + my_100plus_premium > 0)
                        {
                            strTableDetailPrint += "<td style='text-align: right; padding-right: 6px; color: black'>" + (life_premium + tpd_premium + dhc_premium + my_100plus_premium).ToString("C2") + "</td>";
