...
public partial class Pages_GTLI_edit_company : System.Web.UI.Page
{
    ...
    protected void Load_Data()
    {
        ...
        hdfCompanyID.Value = "";
        List<bl_gtli_company> gtli_company_list = new List<bl_gtli_company>();
  
        //Empty GridView
        gvCompany.DataSource = gtli_company_list;
        gvCompany.DataBind();

        //Bind Search Data
        gtli_company_list = da_gtli_company.GetListOfCompanyByCompanyName(txtCompanyName.Text.Trim());
