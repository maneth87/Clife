...
public partial class Pages_GTLI_add_new_transaction_detail : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Get plan by id
        bl_gtli_plan plan = da_gtli_plan.GetPlan(premium.GTLI_Plan_ID);
        ...
        lblPremiumDiscount.Text = (premium.Life_Premium_Discount + premium.TPD_Premium_Discount + premium.Accidental_100Plus_Premium_Discount + premium.DHC_Premium_Discount).ToString("C2");
        ...
        lblPremiumDiscount2.Text = (premium.Life_Premium_Discount + premium.TPD_Premium_Discount + premium.Accidental_100Plus_Premium_Discount + premium.DHC_Premium_Discount).ToString("C2");
        ...
        //view content according to transaction type (1 = original member, 2 = add new, 3 = resign member)
        ...
        switch (premium.Transaction_Type)
        {
            case 1:
                ...
                for (int k = 0; k <= this_policy_employee.Count - 1; k++)
                {
                    ...
                    while (str_certificate_no.Length < 6)
                    {
                        ...
                        if (life_premium + tpd_premium + dhc_premium > 0)
                        {
                        ...
                        if (employee.Certificate_Number != 0)
                        {
                            ...
                            strTableDetailPrint += "<td style='text-align: center;'>" + coverage_period.ToString() + "</td>";
                        }
                        else
                        {
                ...
                tc_sum_insured_total.Style.Add("text_decoration", "underline");
                ...
                tc_life_premium_total.Style.Add("text_decoration", "underline");
                ...
                tc_accidental_100plus_premium_total.Style.Add("text_decoration", "underline");
                ...
                tc_tpd_premium_total.Style.Add("text_decoration", "underline");
                ...
                tc_dhc_premium_total.Style.Add("text_decoration", "underline");
                ...
                tc_total_premium.Style.Add("text_decoration", "underline");
            ...
            case 2:
                //view add new member premium detail (new plan, existing plan)                  

                string plan_name2 = da_gtli_plan.GetPlan(premium.GTLI_Plan_ID).GTLI_Plan;

             
                //employee premium for this policy transaction
                ArrayList this_policy_employee2 = da_gtli_employee.GetListOfEmployeeByGTLIPremiumID(premium.GTLI_Premium_ID);
                ...
                {
                    bl_gtli_employee employee = (bl_gtli_employee)this_policy_employee2[k];
                    life_premium = da_gtli_employee_premium.GetPremiumByGTLICertificateID(employee.GTLI_Certificate_ID, premium.GTLI_Premium_ID, "Death");
                    tpd_premium = da_gtli_employee_premium.GetPremiumByGTLICertificateID(employee.GTLI_Certificate_ID, premium.GTLI_Premium_ID, "TPD");
                    dhc_premium = da_gtli_employee_premium.GetPremiumByGTLICertificateID(employee.GTLI_Certificate_ID, premium.GTLI_Premium_ID, "DHC");
                    accidental_100plus_premium = da_gtli_employee_premium.GetPremiumByGTLICertificateID(employee.GTLI_Certificate_ID, premium.GTLI_Premium_ID, "Accidental100Plus");

                    double employee_sum_insure2 = da_gtli_employee_premium.GetSumInsuredByGTLICertificateID(employee.GTLI_Certificate_ID, premium.GTLI_Premium_ID, "Death");
                    ...
                    while (str_certificate_no.Length < 6)
                    {
                        ...
                        if (life_premium + tpd_premium + dhc_premium > 0)
                        {
                            tc_sub_total_premium.InnerText = (life_premium + tpd_premium + dhc_premium).ToString("C2");
                        }
                        else
                        {
                            tc_sub_total_premium.InnerText = " - ";
                        ...
                        if (employee.Certificate_Number != 0)
                        {
                            ...
                            strTableDetailPrint2 += "<td style='text-align: center;'>" + premium.Effective_Date.ToString("d-MMM-yyyy") + "</td>";
                            strTableDetailPrint2 += "<td style='text-align: center;'>" + premium.Expiry_Date.ToString("d-MMM-yyyy") + "</td>";
                ...
                tc_sum_insured_total2.Style.Add("text-decoration", "underline");
                ...
                {
                    tc_life_premium_total2.Style.Add("text-decoration", "underline");
                ...
                {
                    tc_accidental_100plus_premium_total2.Style.Add("text-decoration", "underline");
                ...
                {
                    tc_tpd_premium_total2.Style.Add("text-decoration", "underline");
                ...
                {
                    tc_dhc_premium_total2.Style.Add("text-decoration", "underline");
                ...
                {
                    tc_total_premium2.Style.Add("text-decoration", "underline");
