...
public partial class Pages_GTLI_total_resigned_member_detail : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblTitle.Text = "Total Resigned Member List";
        lblTitle2.Text = "Total Resigned Member List";
        ...
        lblPolicyNumber.Text = policy_number;
        ...
        lblPremiumReturn.Text = (life_premium + tpd_premium + dhc_premium).ToString("C2");

        //Summary Print
        lblPolicyNumber2.Text = policy_number;
        ...
        lblPremiumReturn2.Text = (life_premium + tpd_premium + dhc_premium).ToString("C2");
