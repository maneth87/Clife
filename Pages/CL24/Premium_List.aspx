<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Pages/Content.master" CodeFile="Premium_List.aspx.cs" Inherits="Pages_CL24_Premium_List" %>
    ...
    <h1>Policy Premium List</h1>
            ...
            <div id="myModalRenewalPremium" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalRenewalPremiumHeader" aria-hidden="true">
                <div class="modal-header">
                    ...
                    <h3 class="panel-title">Premium List</h3>
                </div>

                <div class="modal-body">
                    <ul class="nav nav-tabs" id="myTabPolicySearch">
                        <li class="active"><a href="#SDate" data-toggle="tab" style="text-decoration: none; font-size: 9pt;">Search By Date</a></li>                       
                        <li><a href="#SPolicyYear" data-toggle="tab" style="text-decoration: none; font-size: 9pt;">Search By Policy Year</a></li>                       
                        <li><a href="#SPolicy_Number" data-toggle="tab" style="text-decoration: none; font-size: 9pt;">Search By Policy Number</a></li>                       
                    </ul>
                    <div class="tab-content" style="height: 170px; overflow: hidden;">
                            ...
                            <div style="float: right; width: 90%; padding-left: 50px; margin-right: 0%; border: solid 1px; border-color: lightgray; border-radius: 5px;">
                                <table>
                                    <tr>
                                        <td>
                                            <b>Search by</b>:
                                                    <asp:Panel ID="ddlSearchBy" runat="server" Height="90px" Width="155%">
                        ...
                        <div class="tab-pane" style="height: 70px;" id="SPolicyYear">
            ...
            <div id="dvReport" align="center" width="98%">        
                ...
                <div class="panel-heading">
                    <h3 class="panel-title"> <asp:Label ID="Report_Type" class="panel-title" runat="server"></asp:Label> Premium
