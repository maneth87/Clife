<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="banca_micro_application_renew.aspx.cs" Inherits="Pages_Business_banca_micro_application_renew" %>
        ...
        <ContentTemplate>
            ...
            <table id="tblAppContent" class="table-layout">
                    ...
                    <td style="width: 35%; vertical-align: top; top: 5px; border-right: 1pt solid #d5d5d5; border-bottom: 1pt solid #d5d5d5; background-color: #f6f6f6;">
                        <table style="margin-top: 15px; margin-bottom: 10px; margin-left: 10px;">
                            ...
                            <tr>
                                ...
                                <td style="padding-right: 20px;">
                                    <asp:TextBox ID="txtReletedCertificate" runat="server" class="span3"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="padding-right: 20px;">
                                     <asp:HiddenField ID="hdfOldPolicyId" runat="server" Value="" />
                    ...
                    <td colspan="2" style="width: 100%; vertical-align: top; top: 5px; border-right: 1pt solid #d5d5d5; border-bottom: 1pt solid #d5d5d5; background-color: #f6f6f6;">
                        <table style="width: 100%; margin-top: 10px;">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTermOfCover" class="span3" runat="server"></asp:TextBox>
                                    <span style="color: red;">*</span>
                                </td>
                                <td style="text-align: right">
                                ...
                                <td>
                                    <asp:TextBox ID="txtPremiumPaymentPeriod" class="span3" runat="server"></asp:TextBox>
                                    <span style="color: red;">*</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                   <asp:DropDownList ID="ddlBasicSA" runat="server" CssClass="span2" AutoPostBack="true" OnSelectedIndexChanged="ddlBasicSA_SelectedIndexChanged"></asp:DropDownList>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlPaymentMode" runat="server" Style="text-align: center;"></asp:DropDownList>
                                ...
                                <td>
                                    <asp:TextBox ID="txtPremium" class="span3" runat="server"></asp:TextBox>
                                    <span style="color: red;">*</span>
                                </td>
                                <td style="text-align: right">
                                ...
                                <td>
                                    <asp:TextBox ID="txtBasicDiscount" class="span3" runat="server"></asp:TextBox>
                    ...
                    <td colspan="2" style="width: 100%; vertical-align: top; top: 5px; border-right: 1pt solid #d5d5d5; border-bottom: 1pt solid #d5d5d5; background-color: #f6f6f6;">
                        <table style="width: 100%; margin-top: 10px;">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtRiderProduct" class="span2" runat="server"></asp:TextBox>
                                    <span style="color: red;">*</span>
                                </td>
                                <td style="text-align: right">
                                ...
                                <td>
                                        <asp:DropDownList ID="ddlRiderSumAssure" runat="server" CssClass="span2" AutoPostBack="true" OnSelectedIndexChanged="ddlRiderSumAssure_SelectedIndexChanged"></asp:DropDownList>
                                    <span style="color: red;">*</span>
                                </td>
                                <td style="text-align: right">
                ...
                <tr>
                    <td colspan="2" style="width: 100%; vertical-align: top; top: 5px; border-right: 1pt solid #d5d5d5; border-bottom: 1pt solid #d5d5d5; background-color: #f6f6f6;">
                        <table style="width: 90%; margin-top: 10px;">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTotalPremium" runat="server" class="span3" Style="font-weight: bolder;"></asp:TextBox>
                    ...
                    <td>
                        <asp:TextBox ID="txtTotalPremiumAfterDiscount" class="span3" runat="server" Style="font-weight: bolder;"></asp:TextBox>
                        <span style="color: red;">*</span>
                    </td>
                    ...
                    <table style="width: 100%; margin-top: 10px;">
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <asp:TextBox ID="txtAge" class="span3" runat="server" Style="text-align: center;"></asp:TextBox>
                            ...
                            <td>
                                <asp:TextBox ID="txtPercentageOfShare" class="span3" runat="server" Style="text-align: center;"></asp:TextBox>
                                <span style="color: red;">*</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txtBenAddress" class="span6" runat="server" Height="25px"></asp:TextBox>
            ...
            <tr>
                <td colspan="2" style="width: 100%; vertical-align: top; top: 5px; border-right: 1pt solid #d5d5d5; border-bottom: 1pt solid #d5d5d5; background-color: #f6f6f6;">
                    <table style="width: 100%; margin-top: 10px;">
                        <tr>
                            <td style="text-align: right">
                                <asp:Label runat="server" ID="lblIssueDate" Text="Issue Date (DD-MM-YYYY):"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtIssueDate" class="span3" runat="server" placeholder="DD-MM-YYYY"></asp:TextBox>
                                <span style="color: red;">*</span>
                            </td>
                            <td style="text-align: right">
