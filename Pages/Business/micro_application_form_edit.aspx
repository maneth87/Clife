<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="micro_application_form_edit.aspx.cs" Inherits="Pages_Business_micro_application_form_edit" %>
        ...
        function SearchReferralId() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#dvReferList').setTemplate($("#jTemplateReferral").html());
                    $('#dvReferList').processTemplate(data);
                }
            });
        ...
        <asp:UpdatePanel ID="UP" runat="server">
            <ContentTemplate>
                <ul class="toolbar">
                    ...
                    <li>
                        ...
                        <input type="button"  data-toggle="modal" data-target="#modalConfirmPrinting" style="background: url('../../App_Themes/functions/print_certificate.png') no-repeat; border: none; width:130px;" />
                    </li>
                    <li>
            ...
            <asp:HiddenField ID="hdfChannelID" runat="server" Value="" />
                ...
                <div id="myReferralList" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabelMarketingCodeHeader" aria-hidden="true" data-keyboard="false" data-backdrop="static">
                 ...
                 <!---Popup share Referral--->
                <div id="modalConfirmPrinting" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalConfirmPrinting" aria-hidden="true" data-keyboard="false" data-backdrop="static">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" >×</button>
                        <h3 id="H2">CONFIRM!</h3>
                    </div>
            ...
            <div id="myMarketingCodeList" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabelMarketingCodeHeader" aria-hidden="true" data-keyboard="false" data-backdrop="static">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" >×</button>
                    <h3 id="H3">Select Marketing Code</h3>
                </div>
                <div class="modal-body">
                    <!---Modal Body--->
            ...
            <Triggers>
                              <%-- <asp:PostBackTrigger ControlID="ibtnPrintCertificate" />--%>
            </Triggers>
        </asp:UpdatePanel>
