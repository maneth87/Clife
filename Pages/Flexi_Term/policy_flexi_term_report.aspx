<%@ Page Title="Flexi Term Policy | Report => Policy" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="policy_flexi_term_report.aspx.cs" Inherits="Pages_Report_policy_flexi_term_report" %>
  ...
  <%--  <asp:UpdatePanel ID="ContentPanel" runat="server">
        ...
        <!-- Modal Report Policy Form -->           
           ...
           <!--- Section Sqldatasource--->
                ...
                <asp:SqlDataSource ID="SqlDataSourcePolicyNumber" runat="server" ConnectionString="<%$ ConnectionStrings:ApplicationDBContext %>" SelectCommand="select Flexi_Term_Policy_ID,Policy_Number from Ct_Flexi_Term_Policy order by Policy_Number"></asp:SqlDataSource>
           <!-- End Section  -->
                </div>
