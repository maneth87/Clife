...
public partial class Pages_Business_customer_list : System.Web.UI.Page
{
    ...
    void loadData(string customer_name, string customer_type_id, string id_card, string customer_id, string customer_number)
    {
        tbl_customer = DataSetGenerator.Get_Data_Soure("SP_GET_CUSTOMER_ALL_TYPE", new string[,] { {"@FULL_NAME",customer_name },
