<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="terminated_policy.aspx.cs" Inherits="Pages_CI_terminated_policy" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Toolbar" Runat="Server">
    ...
    <h1>Terminated Policy Report</h1>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Main" Runat="Server">
    ...
    <div class="container" id="div_content">
        ...
        <table style="margin:10px; border:solid 2px;" id ="tbl_filter">
            ...
            <tr>
                 <td style="padding-left:10px;"><asp:Label ID="lblFromDate" runat="server" Text="Terminated Date From" ></asp:Label></td>
