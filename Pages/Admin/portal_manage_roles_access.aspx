<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="portal_manage_roles_access.aspx.cs" Inherits="Pages_Admin_manage_system_roles_access" %>
                                ...
                                <td colspan="7">
                                    <asp:GridView ID="gv_objects" CssClass="grid-layout" runat="server" AutoGenerateColumns="False" Width="100%" HorizontalAlign="Center">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="IsDelete" Visible="true">
                                                <ItemTemplate>
                            ...
                            <asp:GridView ID="gv_pages" CssClass="grid-layout" runat="server" AutoGenerateColumns="False" Width="100%" HorizontalAlign="Center" OnRowDataBound="gv_pages_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="IsView">
                                        <ItemTemplate>
                                            <asp:Label ID="lblIsView" runat="server" Text='<%# Eval("IsView").ToString()=="True"?"YES":"NO"  %>'></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="IsAdd">
                                        <ItemTemplate>
                                            <asp:Label ID="lblIsAdd" runat="server" Text='<%# Eval("IsAdd").ToString()=="True"?"YES":"NO"  %>'></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="IsUpdate">
                                        <ItemTemplate>
                                            <asp:Label ID="lblIsUpdate" runat="server" Text='<%# Eval("IsUpdate").ToString()=="True"?"YES":"NO"  %>'></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="IsDelete">
                                        <ItemTemplate>
                                            <asp:Label ID="lblIsDelete" runat="server" Text='<%# Eval("IsDelete").ToString()=="True"?"YES":"NO"  %>'></asp:Label>
                                            <asp:HiddenField ID="hdfIsDelete" runat="server" Value='<%# Eval("IsDelete") %>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="IsAdmin">
                                        <ItemTemplate>
                                            <asp:Label ID="lblIsAdmin" runat="server" Text='<%# Eval("IsAdmin").ToString()=="True"?"YES":"NO"  %>'></asp:Label>
