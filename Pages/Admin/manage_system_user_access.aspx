<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="manage_system_user_access.aspx.cs" Inherits="Pages_Admin_manage_system_user_access" %>
        ...
        <asp:UpdatePanel ID="UP" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">Manage System User Access</h3>
                </div>
                <div class="panel-body">
                        ...
                        <table>
                            <tr>
                                ...
                                <td colspan="6" style="text-align:right;">
                                    <span style="color:red; font-style:italic;">** This user access is override on role access.</span>
                                </td>
                            </tr>
                            <tr>
                                 <td>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Exist System User Access List
                <asp:Label ID="lblCount" runat="server" ForeColor="Red"></asp:Label></h3>
                        </div>

                        <div class="panel-body">
                            <asp:GridView ID="gv_pages" CssClass="grid-layout" runat="server" AutoGenerateColumns="False" Width="100%" HorizontalAlign="Center" OnRowDataBound="gv_pages_RowDataBound" OnRowCommand="gv_pages_RowCommand">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                           <asp:LinkButton runat="server" ForeColor="Red" ID="lbtnDelete" Text="X" ToolTip="Delete" OnClientClick="return confirm('Confirm delete.');" CommandName="CMD_DELETE" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"></asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                </Columns>
