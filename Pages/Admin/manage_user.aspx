<%@ Page Title="Clife System | Administrator => Users" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="manage_user.aspx.cs" Inherits="Pages_admin_manage_user" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function SelectSingleCheckBox(ckb, user_id, user_name, isapproved, roleid, email, locked) {
            ...
            $('#Main_editddlStatus').val(isapproved);
            ...
            <asp:GridView ID="GvUser" PageSize="20" OnPageIndexChanged="GvUser_PageIndexChanged" OnPageIndexChanging="GvUser_PageIndexChanging" CssClass="grid-layout; grid" Width="100%" runat="server" AutoGenerateColumns="False" BorderColor="Black" AllowPaging="true" PagerSettings-Mode="NumericFirstLast" HorizontalAlign="Center" PagerStyle-HorizontalAlign="Center">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Locked" HeaderStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <img src='<%# Eval("IsLockedOut") == "1" ? "../../App_Themes/functions/locked.png" :"../../App_Themes/functions/unlocked.png" %>' alt="-" width="16px" height="16px" />
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Approved" HeaderStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <img src='<%# Eval("IsApproved") == "1" ? "../../App_Themes/functions/active.png" :"../../App_Themes/functions/inactive.png" %>' alt="Photo" />
                        </ItemTemplate>
                        <HeaderStyle Width="50" Height="25" />
                        <ItemStyle Width="30" HorizontalAlign="Center" />
                    </asp:TemplateField>
    ...
    <div id="myModalAddUser" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalAddUserHeader" aria-hidden="true">
        <%-- <div class="modal-header">
            ...
            <h3 id="myModalCancelSaleAgentHeader">Add New User Account</h3>
        </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="background-color: #e5e3e3">
              ...
              <%--  <asp:CreateUserWizard ID="CreateUserWizard" runat="server" ContinueButtonType="Button" CreateUserButtonText="Save" Width="98%" DisableCreatedUser="false"  LoginCreatedUser="False" CompleteSuccessTextStyle-Wrap="True" FinishCompleteButtonStyle-BorderStyle="NotSet">
                    <CreateUserButtonStyle CssClass="btn btn-primary" BorderStyle="Solid" Font-Bold="false" Font-Size="Medium" Height="28px" Width="80px" />
                    <WizardSteps>
                                ...
                                <table class="table table-bordered" style="width: 100%">
                                    ...
                                    <tr>
                                        <td align="right" style="width: 150px;">&nbsp;  
                                            <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName">User Name: 
                                                <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ForeColor="red" ControlToValidate="UserName" ErrorMessage="User Name is required." ToolTip="User Name is required." ValidationGroup="CreateUserWizard">*</asp:RequiredFieldValidator>
                                            </asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="UserName" runat="server" Width="96%" Height="10%"></asp:TextBox>

                                        </td>
                                    </tr>
                                    <td>&nbsp;
                                           <asp:Label ID="RoleLable" runat="server" AssociatedControlID="ddlUserRole">Role:<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="red" ControlToValidate="ddlUserRole" ErrorMessage="Role is required." ToolTip="Role is required." ValidationGroup="CreateUserWizard" InitialValue="0">*</asp:RequiredFieldValidator></asp:Label>
                                    </td>
                                    <td style="vertical-align: calc()">
                                    ...
                                    <tr>
                                        <td align="right" style="width: 150px;">&nbsp;
                                            <asp:Label ID="PasswordLabel" runat="server" AssociatedControlID="Password">Password:
                                                <asp:RequiredFieldValidator ID="PasswordRequired" runat="server" ForeColor="red" ControlToValidate="Password" ErrorMessage="Password is required." ToolTip="Password is required." ValidationGroup="CreateUserWizard">*</asp:RequiredFieldValidator>
                                            </asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="Password" runat="server" TextMode="Password" Width="96%" Height="10%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right" style="width: 150px;">&nbsp;
                                            <asp:Label ID="ConfirmPasswordLabel" runat="server" AssociatedControlID="ConfirmPassword">Re-Password:
                                                <asp:RequiredFieldValidator ID="ConfirmPasswordRequired" ForeColor="red" runat="server" ControlToValidate="ConfirmPassword" ErrorMessage="Confirm Password is required." ToolTip="Confirm Password is required." ValidationGroup="CreateUserWizard">*</asp:RequiredFieldValidator>
                                            </asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="ConfirmPassword" runat="server" TextMode="Password" Width="96%" Height="10%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="right" style="width: 150px;">&nbsp;
                                            <asp:Label ID="EmailLabel" runat="server" AssociatedControlID="Email">E-mail:
                                                <asp:RequiredFieldValidator ID="EmailRequired" runat="server" ForeColor="red" ControlToValidate="Email" ErrorMessage="E-mail is required." ToolTip="E-mail is required." ValidationGroup="CreateUserWizard">*</asp:RequiredFieldValidator>
                                            </asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td align="center" colspan="2">
                                            <asp:CompareValidator ID="PasswordCompare" runat="server" ForeColor="red" ControlToCompare="Password" ControlToValidate="ConfirmPassword" Display="Dynamic" ErrorMessage="The Password and Confirmation Password must match." ValidationGroup="CreateUserWizard"></asp:CompareValidator>
                                            <asp:Literal ID="ErrorMessage" runat="server" EnableViewState="False"></asp:Literal>

                                            <asp:CustomValidator ID="CustomValidator1"
                                                ClientValidationFunction="ClientValidate"
                                                ControlToValidate="Password" runat="server"
                                                ErrorMessage="The password must be more than 7 characters."
                        ...
                        <asp:CompleteWizardStep ID="CompleteWizardStep1" runat="server">
                            <ContentTemplate>
                                <table style="width: 98%; font-size: 100%;">
                                    <tr>
                                        <td align="center">&nbsp;</td>
                                    </tr>
                                    <tr style="text-align: center; color: green; font-size: medium">
                                        <td>User account has been successfully created.</td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                            <asp:Button ID="ContinueButton" runat="server" Text="Continue" AlternateText="Continue" CausesValidation="False" CommandName="Continue" ValidationGroup="CreateUserWizardEmployer" PostBackUrl="~/default.aspx" />
                                        </td>
                                    </tr>
                                </table>
                            </ContentTemplate>
                    ...
                    <tr>
                        <td align="center" colspan="2">
                            ...
                            <div align="right">
                                ...
                                <input type="button" runat="server" class="btn btn-primary" style="height: 27px;" onclick="EditUser();" value="Update" title="Update" />
