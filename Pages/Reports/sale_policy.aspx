<%@ Page Title="Clife Sale Report => Policy Details" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="sale_policy.aspx.cs" Inherits="Pages_Reports_sale_policy" %>
		...
		<%--here is the block code--%>
                ...
                <div class="modal-body">
                    ...
                    <table  text-align: left;">
                        ...
                        <tr>
                            <td>Agent Code</td>
                            <td>
                                <asp:TextBox ID="txtAgent_Code"  runat="server"  width="136px" TabIndex="3" ></asp:TextBox>
                           </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Sales Policy</h3>
                    
                </div>
                
             <!-- Modal Report Policy Status Form -->
