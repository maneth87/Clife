...
public partial class Pages_Reports_sale_policy: System.Web.UI.Page
{
    ...
    protected void ReportApplicationsByStatus()
    {
        ...
        if (txtFrom_date.Text == "" && txtTo_date.Text == "")
        {
            ...
            report_sale_policy_list = da_report_sale_policy.GetPolicyBySaleAgentIDAndEffectiveDate(txtAgent_Code.Text, DateTime.Parse("1900/01/01"), DateTime.Parse("1900/01/01"));
        }
        else
        {
            report_sale_policy_list = da_report_sale_policy.GetPolicyBySaleAgentIDAndEffectiveDate(txtAgent_Code.Text, DateTime.Parse(txtFrom_date.Text, dtfi), DateTime.Parse(txtTo_date.Text, dtfi));
        }
