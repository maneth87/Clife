<%@ Page Title="Clife | Reports => Policy Reinstatement" Language="C#" ValidateRequest="false" AutoEventWireup="true" MasterPageFile="~/Pages/Content.master" CodeFile="report_policy_reinstatement.aspx.cs" Inherits="Pages_Reports_report_policy_reinstatement" %>
    ...
    <asp:UpdatePanel ID="ContentPanel" runat="server">
        ...
        <div class="panel panel-default">
             ...
             <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Policy Reinstatement Report</h3>
                </div>
            ...
            <div class="panel-body">
                ...
                <div class="PrintPD"> 
                    ...
                    <table id="tblExport" cellpadding="0" cellspacing="0" width="1280px;" border="1">
	                <thead>
		                ...
		                <tr>
			                ...
			                <th class="th">Insured's name</th>
			                <th class="th">Product</th>
			                <th class="th">SI(USD)</th>
			                <th class="th">Premium</th>
                            <th class="th">Payment Mode</th>
                            <th class="th">Contract Date</th>
			                <th class="th">Lapsed on</th>
			                <th class="th">Reinstatement on</th>
			                <th class="th">Duration LAP(day)</th>
                            <th class="th">Prem & Interest</th>
                            <th class="th">Agent</th>
                            <th class="th">Agent Code</th>
  		                </tr>
	                </thead>
	                <tbody>
			                <%=getWhileLoopData()%>
