<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Pages/Content.master" CodeFile="Premium_Report.aspx.cs" Inherits="Pages_Reports_Premium_Report" %>
            ...
            <div id="div_main" runat="server" class="panel panel-default">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Premium Report (All Product)</h3>
                ...
                <div id="myModalReportProductPremium"  class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalReportHeader" aria-hidden="true">
                    <div class="modal-header">
                        ...
                        <h3 class="panel-title">Premium Report Search</h3>
                    </div>
