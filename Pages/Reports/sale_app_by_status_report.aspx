<%@ Page Title="Clife Sale Report => Application Status" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="sale_app_by_status_report.aspx.cs" Inherits="Pages_Reports_sale_app_by_status_report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Toolbar" Runat="Server">
    <ul class="toolbar" style="text-align:left">
        ...
        <li>
            <asp:ImageButton ID="ImgBtnSearch" data-toggle="modal" data-target="#myModalReportSaleAppByStatus" runat="server" ImageUrl="~/App_Themes/functions/search.png" />
        </li>      
    </ul>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" Runat="Server">
    ...
    <asp:UpdatePanel ID="ContentPanel" runat="server">
		...
		<%--here is the block code--%>
            ...
            <div id="myModalReportSaleAppByStatus"  class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalReportHeader" aria-hidden="true">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h3 class="panel-title">Application Status Search</h3>
                </div>
            ...
            <!--End Modal Report Application Status Form-->
