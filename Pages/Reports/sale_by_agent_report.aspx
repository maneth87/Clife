<%@ Page Title="Clife Sale Report => Sale Performance" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="sale_by_agent_report.aspx.cs" Inherits="Pages_Reports_sale_by_agent_report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Toolbar" Runat="Server">
    <ul class="toolbar" style="text-align:left">
        ...
        <li>
            <asp:ImageButton ID="ImgBtnSearch" data-toggle="modal" data-target="#myModalReportSaleByAgent" runat="server" ImageUrl="~/App_Themes/functions/search.png" />
        </li>      
    </ul>
    ...
    <asp:UpdatePanel ID="ContentPanel" runat="server">
		...
		<%--here is the block code--%>
            ...
            <div class="panel panel-default">
             ...
             <!-- Modal Report Sale Performance Form -->
            ...
            <div id="myModalReportSaleByAgent"  class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalReportHeader" aria-hidden="true">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h3 class="panel-title">Sales Performance Search</h3>
                </div>
            ...
            <!--End Modal Report Sale Performance Form-->
