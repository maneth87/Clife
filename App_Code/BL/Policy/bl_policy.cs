...
/// <summary>
/// Summary description for bl_policy
/// </summary>
public class bl_policy
{
    #region "Constructor"
    public bl_policy()
	{
    ...
    private int _Is_Standard;
    private DateTime _Created_On;
    private string _Created_By;
    private string _Created_Note;
    private string _ChannelItem_ID;
    ...
    public string ChannelItem_ID
    {
        get { return _ChannelItem_ID; }
        set { _ChannelItem_ID = value; }
    }
    #endregion
